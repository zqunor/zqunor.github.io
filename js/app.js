...
(function ($) {
	...
	"use strict";
	const scrollCorrection = 60; // (header height = 50px) + (gap = 20px)
	...
	function setHeader() {
		...
		// $gotop.click(()=>scrolltoElement(document.body));
	...
	function setHeaderMenu() {
		...
		if (location.pathname === '/' ||location.pathname === '/index.html' || location.pathname.startsWith('/page/')) {
